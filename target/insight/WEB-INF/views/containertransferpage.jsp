	...
	<div class="row">
		<div class="row">
			<form class="col s12" role="form" method="post"
				id="containertransferform"
				action="/insight/containertransfers/getexistingorder">
				<div class="row">
					<h5 class="light col s12">Container Transfer</h5>
				</div>
				<div class="row"></div>
	...
	<script>
		$(document).ready(
				function() {
					...
					$("#existingordernosearchtxt").keypress(function(event) {
						if (event.which == 13) {
					...
					//yccprofortuneremove
					$("#yccprofortuneremovebtn").click(function() {
						
						 $("#containertransferform").attr("action", "/insight/containertransfers/yccprofortuneremove");
						$("html, body").animate({
							scrollTop : 0
						}, "fast");
						$("#containertransferform").submit();
					});
					//updatevendorparts
					$("#updatevendorpartsbtn").click(function() {
						
						 $("#containertransferform").attr("action", "/insight/containertransfers/updatevendorparts");
						$("html, body").animate({
							scrollTop : 0
						}, "fast");
						$("#containertransferform").submit();
					...
					$("#updateorderbtn").click(function() {
						 ...
						 $("#containertransferform").attr("action", "/insight/containertransfers/updateorder");
						$("html, body").animate({
							scrollTop : 0
						}, "fast");
						$("#containertransferform").submit();
					...
					$("#removeduplicatesbtn").click(function() {
						 ...
						 $("#containertransferform").attr("action", "/insight/containertransfers/removeduplicates");
						$("html, body").animate({
							scrollTop : 0
						}, "fast");
						$("#containertransferform").submit();
					...
					$("#postorderbtn").click(function() {
						 ...
						 $("#containertransferform").attr("action", "/insight/containertransfers/postorder");
						$("html, body").animate({
							scrollTop : 0
						}, "fast");
						$("#containertransferform").submit();
					...
					$("#preorderbtn").click(function() {
						 ...
						 $("#containertransferform").attr("action", "/insight/containertransfers/preorder");
						$("html, body").animate({
							scrollTop : 0
						}, "fast");
						$("#containertransferform").submit();
					...
					//getlabels
					$("#getlabelsbtn").click(function() {
						
						 $("#containertransferform").attr("action", "/insight/containertransfers/getlabels");
						$("html, body").animate({
							scrollTop : 0
						}, "fast");
						$("#containertransferform").submit();
					...
					//savepartslist
					$("#savepartslistbtn").click(function() {
						
						 $("#containertransferform").attr("action", "/insight/containertransfers/savepartslist");
						$("html, body").animate({
							scrollTop : 0
						}, "fast");
						$("#containertransferform").submit();
					...
					$("#getexistingorderbtn").click(function() {
						...
						$("#containertransferform").attr("action", "/insight/containertransfers/getexistingorder");
						$("html, body").animate({
							scrollTop : 0
						}, "fast");
						$("#containertransferform").submit();
					...
					$("#resetunitonorderbtn").click(function() {
						
						$("#containertransferform").attr("action", "/insight/containertransfers/resetunitonorder");
						$("html, body").animate({
							scrollTop : 0
						}, "fast");
						$("#containertransferform").submit();
