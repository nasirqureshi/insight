...
<body bgcolor="#f4f6f8"
	...
	<div class="row">
		<form class="col s12" role="form" method="post"
			id="newpartsexceluploadform" name="newpartsexceluploadform"
			action="/insight/parts/newpartsexceluploadsearch">
			<div class="row">
				<h5 class="light col s12">Upload New Parts(Excel)</h5>
			</div>
			<div class="row">
				<div class="col s2">
					<input type="hidden" id="newpartsexceluploadmode"
						name="newpartsexceluploadmode" value="newpartsexceluploadinitiate">
				</div>
			</div>
			<div class="card">
					...
					<div class="row">
						<div class="col s4">
							<div class="file-field input-field">
								<div class="btn">
									<span>File</span> <input name="files[0]" type="file"
										class="file">
								</div>
								<div class="file-path-wrapper">
									<input class="file-path validate" type="text"
										id="newpartsexceluploadinitiateBtn"
										name="newpartsexceluploadinitiateBtn" value="Upload Excel">
								</div>
							</div>
						</div>
					</div>
		...
		$(document)
				.ready(
						function() {
							...
							$("#newpartsexceluploadinitiateBtn")
									.click(
											function() {
												$("#newpartsexceluploadform")
														.attr("action",
																"/insight/parts/newpartsexceluploadinitiate");
												$("#newpartsexceluploadform")
														.submit();
											});

							$("#newpartsexceluploadform").submit(function() {
