...
<title>Update parts cost price</title>
		...
		<div class="row">
			<div class="container  blue-grey lighten-5">
				<form class="col s12" role="form" method="post"
					modelAttribute="partsfile" id="updatepartpriceform"
					action="/insight/parts/updatepartcostanddiscountprice"
					enctype="multipart/form-data">
					<div class="row">
						<h4 class="light col s12">Update Parts (Cost Price and
							Discount -> Cost Price and List Price)</h4>
					</div>
					<div class="row">
						<div class="col s12">
							<div class="card grey">
							...
							<div class="row">
								...
								<div class="col s2">
									<button
										...
										type="button" id="fileUploadBtn" name="fileUploadBtn"
										value="uploadpartsfile">
	...
	<script>
            $(document).ready(function () {
                ...
                $("#fileUploadBtn").click(function () {
                    $("#updatepartpriceform").submit();
                });
                $("#labelDownloadBtn").click(function () {
                    $("#downloadReportForm").submit();
                });

                $("#updatepartpriceform").submit(function () {
