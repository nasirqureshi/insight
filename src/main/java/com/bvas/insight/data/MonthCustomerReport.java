...
public class MonthCustomerReport implements Serializable {
	...
	public MonthCustomerReport() {
		super();
	}

	public MonthCustomerReport(Integer yr, Integer mnth, String companyname, BigDecimal cnt, BigDecimal ourprice,
