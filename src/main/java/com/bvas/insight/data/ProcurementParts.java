...
public class ProcurementParts implements Serializable {
	...
	public ProcurementParts() {
		super();
	}

	public ProcurementParts(String partno, String manufacturername, String makemodelname, String year, String capa,
			String ordertype, String partdescription, Integer unitsinstock, Integer unitsonorder, Integer reorderlevel,
			Integer safetyquantity, String dpinumber, String keystonenumber, BigDecimal actualprice,
			BigDecimal costprice, BigDecimal percent, BigInteger quantitytoorder) {
		super();
