...
<body bgcolor="#f4f6f8"
	...
	<div class="row">
		<div class="row">
			<div class="container  blue-grey lighten-5">
				<form class="col s12" role="form" method="post" id="partsfixform"
					action="/insight/parts/partsfix" modelAttribute="uploadForm"
					enctype="multipart/form-data">
					<div class="row">
						<input type="hidden" id="partsfixmode" name="partsfixmode"
							value="">
					</div>
					<div class="row">
						<h5 class="light col s12">Fix Parts</h5>
					</div>
					<div class="row">
						<div class="col s12">
							<div class="card grey">
							...
							<div class="row">
								...
								<div class="col s2">
									<button
										...
										type="button" id="partsfixbtn" name="partsfixbtn"
										value="partsfix">
										<i class="mdi-maps-local-pharmacy right"></i>
									</button>
								</div>
							</div>
						</div>
	...
	<script>
		$(document).ready(function() {
			...
			$("#partsfixbtn").click(function() {

				$('input[name=partsfixmode]').val('partsfix');
				$("#partsfixform").submit();

			});

			$("#partsfixform").submit(function() {
