...
<body bgcolor="#f4f6f8"
		...
		<div class="row">
			<div class="container  blue-grey lighten-5">
				<form class="col s12" role="form" method="post"
					id="addtocontainerform" action="/insight/orders/addtocontainer"
					modelAttribute="uploadForm" enctype="multipart/form-data">
					<div class="row">
						<i class="small mdi-communication-vpn-key">Add Container</i>
					</div>
					<div class="row">
						<input type="hidden" id="addtocontainermode"
							name="addtocontainermode" value="">
					</div>
					<div class="row">
						<div class="col s12">
							<div class="card grey  z-depth-3">
						...
						<div class="card-content">
							<div class="row">
								...
								<div class="input-field col s2">
									<input name="addcontainernotxt" id="addcontainernotxt" value=""
										type="text" required> <label for="addcontainernotxt"><strong>Container
											#</strong> </label>
								</div>
								<div class="col s2">
									<button
										class="btn-floating btn-large waves-effect waves-light  blue"
										type="button" id="addcontainernobtn" name="addcontainernobtn"
	...
	<script>
		$(document).ready(function() {
			...
			$("#addcontainernobtn").click(function() {

				$('input[name=addtocontainermode]').val('addtocontainer');
				$("#addtocontainerform").submit();

			});
			
			

			$("#addtocontainerform").submit(function() {
				var isFormValid = true;
				if ($('#addtocontainermode').val() == 'addtocontainer') {
					if ($('#addcontainernotxt').val() == '') {
						alert('container number cannot be blank');
						isFormValid = false;
					}
				}
