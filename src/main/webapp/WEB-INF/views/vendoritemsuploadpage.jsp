...
<body bgcolor="#f4f6f8"
		...
		<div class="row">
			<div class="container  blue-grey lighten-5">
				<form class="col s12" role="form" method="post"
					id="vendoritemsuploadform"
					action="/insight/orders/vendoritemsupload"
					modelAttribute="uploadForm" enctype="multipart/form-data">
					<div class="row">
						<input type="hidden" id="vendoritemsuploadmode"
							name="vendoritemsuploadmode" value="">
					</div>
					<div class="row">
						<h5 class="light col s12">Upload Vendor Items</h5>
					</div>
					<div class="row">
						<div class="col s12">
							<div class="card grey">
							...
							<div class="row">
								...
								<div class="col s2">
									<button
										...
										type="button" id="vendoritemsuploadbtn"
										name="vendoritemsuploadbtn" value="vendoritemsupload">
	...
	<script>
		$(document).ready(function() {
			...
			$("#vendoritemsuploadbtn").click(function() {

				$('input[name=vendoritemsuploadmode]').val('vendoritemsupload');
				$("#vendoritemsuploadform").submit();

			});

			$("#vendoritemsuploadform").submit(function() {
